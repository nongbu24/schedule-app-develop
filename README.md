...
| **Error**                | `400 Bad Request` - 필수값 누락 <br> `500 Internal Server Error` - 로그인 하지 않고 생성 요청                                                                                          |
| **비고**                   | 로그인 후 일정 생성 가능                                                                                                                                                         |
...
| 비고                       | 로그인한 유저 본인의 일정 제목과 내용만 수정 가능                                                                                                                                                |
...
| **Error**         | `500 Internal Server Error` - 존재하지 않는 일정 삭제 요청 |
| **비고**            | 로그인한 유저 본인의 일정만 삭제 가능                          |
...
| **Error**                | `400 Bad Request` - 필수값 누락 <br>`500 Internal Server Error` - `password` 8자 미만 설정                                                                           |
...
| **Error**                | `500 Internal Server Error` - `email` 혹은 `password` 불일치            |
...
| **URL**      | `DELETE /users`                                |
| **Response** | `204 NO_CONTENT`                               |
| **Error**    | `500 Internal Server Error` - 존재하지 않는 유저 삭제 요청 |
